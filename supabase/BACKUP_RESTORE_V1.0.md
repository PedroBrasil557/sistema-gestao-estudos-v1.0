...
5. Valide `backupFormat = gestao-estudos-backup` e `schemaVersion = 1.0`.
...
Na v1.0 a restauração permanece deliberadamente **controlada/manual**. Não existe botão de “restaurar tudo” na interface para evitar duplicação, sobrescrita acidental e corrupção de relacionamentos.
